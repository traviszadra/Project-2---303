...
Ndays = 1
D = 0  # diffusion coefficient (mi²/day)
...
################## import road array and make the new source #####################################################
...
def source(t):
    ...
    s = 200 * roads                                                # needed to make it a constant very high source for testing purposes
    return s
##################################################################################################################
...
########################################################### time based source must be included in the time step loop #########
    S = source(t)
    Sinterior = S[1:-1,1:-1]
