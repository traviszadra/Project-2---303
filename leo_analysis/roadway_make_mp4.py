# -*- coding: utf-8 -*-
"""
Created on Sun Apr 26 18:40:47 2026
...
# C = cp.zeros((Nx,Ny)) + cp.asarray(S0)
# Cnew = C.copy()
...
Chistory = np.load(r'F:\Documents\School\2026 Spring\EMEC 303\travis high res cuda12311.npy', mmap_mode='r')
#Chistory = np.zeros((steps // plot_freq, Nx, Ny), dtype=np.float32) # C_history stores the concentration info at each time step
...
poll_img = ax.imshow(
    ...
    cmap='jet', vmin=0, vmax=Chistory.max(), alpha=0.6
)
...
ani.save(r'F:\Documents\School\2026 Spring\EMEC 303\upscaled_sim_animation2.mp4', fps=30, dpi=100, bitrate = 2000)
